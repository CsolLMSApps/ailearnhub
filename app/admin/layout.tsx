...
// Auth is handled CLIENT-SIDE by AdminAuthGuard.
// Server-side getUser() was unreliable due to cookie reading issues in this setup.
// The browser Supabase client always has access to the session — this is the reliable path.
