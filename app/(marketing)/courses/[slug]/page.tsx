...
const COURSE_SEO: Record<string, {
  ...
  'prompt-engineering-mastery': {
    ...
    keywords: [
      ...
      'Affordable prompt engineering training',
              ...
              {alsoBought.map((c) => (
                ...
                >
                  ...
                  <div className="h-40 bg-gradient-to-br from-[#FF6F00] to-[#E65100] flex items-center justify-center relative">
                    <Image
                      src={['ai-for-beginners', 'chatgpt-mastery', 'ai-tools-productivity', 'email-marketing-ai', 'prompt-engineering-mastery', 'social-media-marketing-ai'].includes(c.slug) ? `/images/courses/${c.slug}.jpg` : `/images/courses/${c.slug}.svg`}
                      alt={c.title}
                      width={120}
                      height={120}
