...
// Updated Refund Policy - 24 hours, Stripe compliant
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">Master AI skills with practical courses</p>
            </div>
            <div>
              <h4 className="font-bold mb-4">Legal</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="/terms" className="hover:text-[#FF6F00]">Terms of Service</a></li>
                <li><a href="/privacy" className="hover:text-[#FF6F00]">Privacy Policy</a></li>
                <li><a href="/refund-policy" className="hover:text-[#FF6F00]">Refund Policy</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4">Support</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="/contact" className="hover:text-[#FF6F00]">Contact Us</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="/courses" className="hover:text-[#FF6F00]">Browse All</a></li>
                <li><a href="/pricing" className="hover:text-[#FF6F00]">Pricing</a></li>
              </ul>
            </div>
          </div>
